...
<c:if test="${!empty theme }">
   ...
   <form action="update.jsp" method="post" enctype="multipart/form-data" onSubmit="return validate(this)">
      ...
      <table width="100%" border="1" cellpadding="1" cellspacing="0">
         ...
         <tr>
            <td>이미지</td>
            <td><input type="file" name="imageFile"> <c:if test="${!empty theme.image }">
                  <br>
         ...
         <tr>
            <td>내용</td>
            <td><textarea name="content" rows="8" cols="40">${theme.content }</textarea></td>
         </tr>
         <tr>
            <td colspan="2"><input type="submit" value="수정"> <input type="button" value="취소" onClick="javascript:history.go(-1)"></td>
         </tr>
      </table>

      <input type="hidden" name="page" value="${param.page }">
      <c:forEach var="searchCond" items="${paramValues.search_cond }">
         <c:if test="${serchCond == 'title'}">
