...
<body bgcolor="<%=bodyback_c%>">
	<form action="registerPro.jsp" name="regForm" method="post" onsubmit="return inputCheck()">
		...
		<tr>
			...
			<td bgcolor="<%= value_c %>"><input type="text" name="id" size="30" /></td>
			<td bgcolor="<%= value_c %>">아이디를 입력하세요.</td>
		</tr>
		<tr>
			<th bgcolor="<%= title_c %>">비밀번호</th>
			<td bgcolor="<%= value_c %>"><input type="text" name="passwd" size="30" /></td>
			<td bgcolor="<%= value_c %>">비밀번호를 입력하세요.</td>
		</tr>
		<tr>
			<th bgcolor="<%= title_c %>">비밀번호</th>
			<td bgcolor="<%= value_c %>"><input type="text" name="repasswd" size="30" /></td>
			<td bgcolor="<%= value_c %>">비밀번호를 재입력하세요.</td>
		</tr>
		<tr>
			<th bgcolor="<%= title_c %>">이름</th>
			<td bgcolor="<%= value_c %>"><input type="text" name="name" size="30" /></td>
		...
		<tr>
			...
			<td bgcolor="<%= value_c %>"><input type="text" name="tel" size="30" /></td>
