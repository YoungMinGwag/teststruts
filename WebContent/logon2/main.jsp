...
<tr>
	...
	<form name="inform" method="post" action="/KH10/logon/loginPro.do">
...
<tr>
	...
	<input type="button" value="회원가입" onclick="document.location.href='/KH10/logon/inputForm.do'">
	</td>
</form>
</tr>
</table>
...
<tr>
	...
	${sessionScope.memId}님이<br>
	 방문하셨습니다.
	 <form method="post" action="/KH10/logon/logout.do">
	 <input type="submit" value="로그아웃">
	 <input type="button" value="회원정보변경" onclick="document.location.href='/KH10/logon/modify.do'">
	 </form>
	</td>
	</tr>
<tr>
