...
<form action="/KH10/logon/modifyPro.do" method="post" name="userinput" onsubmit="return checkIt()">
   ...
   <tr> 
    ...
    <tr> 
      <td colspan="2" align="center" bgcolor="${value_c}"> 
       ...
       <input type="button" value="취  소" onclick="document.location.href='/KH10/logon/main.do'">      
      </td>
    </tr>
  </table>
</form>
