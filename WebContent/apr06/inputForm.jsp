...
<script language="JavaScript">
	...
	function openConfirmid(userinput){
		...
		open(url,"confirm","toolbar=no,location=no status=no,menuber=no,scrollbars=no,resizable=no,width=300,height=200");
	}
...
<body bgcolor="<%=bodyback_c%>">
	<form action="inputpro.jsp" method="post" name="userinput"
		...
		<table width="600" border="1" cellspacing="0" cellpadding="3"
			align="center">
			<tr>
				<td colspan="2" height="39" align="center" bgcolor="<%=value_c%>"><font><b>회원가입</b></font></td>
			</tr>
			<tr>
