...
public class GetMessageListService {
	...
	private static final int MESSAGE_CONUT_PER_PAGE=3;
	...
	public MessageListView getMessageList(int pageNumber) throws ServiceException{
		...
		try {
			...
			if(messageTotalCount >0) {
				firstRow=(pageNumber -1)*MESSAGE_CONUT_PER_PAGE +1;
				endRow=firstRow+MESSAGE_CONUT_PER_PAGE-1;
			...
			return new MessageListView(messageList, messageTotalCount, currentPageNumber, MESSAGE_CONUT_PER_PAGE, firstRow, endRow);
